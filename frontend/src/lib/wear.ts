...
// Exported so anything else needing the real tier boundaries (the price
// curve chart's wear bands) shares this one list instead of a second copy.
export const WEAR_THRESHOLDS: [number, string][] = [
  [0.07, "Factory New"],
  [0.15, "Minimal Wear"],
  [0.38, "Field-Tested"],
  [0.45, "Well-Worn"],
